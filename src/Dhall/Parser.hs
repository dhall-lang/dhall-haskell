...
annotatedExpression embedded = alternative0 <|> alternative1 <|> alternative2
  where
    alternative0 = do
        _merge
...
equalExpression =
    makeOperatorExpression notEqualExpression _equal BoolEQ
