...
instance (Eq s, Eq a) => Eq (Expr s a) where
  Const c == Const c' = c == c'
  Var v == Var v' = v == v'
  Lam v e1 e2 == Lam v' e1' e2' = v == v' && e1 == e1' && e2 == e2'
  Pi v e1 e2 == Pi v' e1' e2' = v == v' && e1 == e1' && e2 == e2'
  App e1 e2 == App e1' e2' = e1 == e1' && e2 == e2'
  Let v maybeE e1 e2 == Let v' maybeE' e1' e2' = v == v' && maybeE == maybeE' && e1 == e1' && e2 == e2'
  Annot e1 e2 == Annot e1' e2' = e1 == e1' && e2 == e2'
  Bool == Bool = True
  BoolLit b == BoolLit b' = b == b'
  BoolAnd e1 e2 == BoolAnd e1' e2' = e1 == e1' && e2 == e2'
  BoolOr e1 e2 == BoolOr e1' e2' = e1 == e1' && e2 == e2'
  BoolEQ e1 e2 == BoolEQ e1' e2' = e1 == e1' && e2 == e2'
  BoolNE e1 e2 == BoolNE e1' e2' = e1 == e1' && e2 == e2'
  BoolIf e1 e2 e3 == BoolIf e1' e2' e3' = e1 == e1' && e2 == e2' && e3 == e3'
  Natural == Natural = True
  NaturalLit n == NaturalLit n' = n == n'
  NaturalFold == NaturalFold = True
  NaturalBuild == NaturalBuild = True
  NaturalIsZero == NaturalIsZero = True
  NaturalEven == NaturalEven = True
  NaturalOdd == NaturalOdd = True
  NaturalToInteger == NaturalToInteger = True
  NaturalShow == NaturalShow = True
  NaturalPlus e1 e2 == NaturalPlus e1' e2' = e1 == e1' && e2 == e2'
  NaturalTimes e1 e2 == NaturalTimes e1' e2' = e1 == e1' && e2 == e2'
  Integer == Integer = True
  IntegerLit i == IntegerLit i' = i == i'
  IntegerShow == IntegerShow = True
  IntegerToDouble == IntegerToDouble = True
  Double == Double = True
  DoubleLit d == DoubleLit d' = d == d'
  DoubleShow == DoubleShow = True
  Text == Text = True
  TextLit cs == TextLit cs' = cs == cs'
  TextAppend e1 e2 == TextAppend e1' e2' = e1 == e1' && e2 == e2'
  List == List = True
  ListLit maybeE seqE == ListLit maybeE' seqE' = maybeE == maybeE' && seqE == seqE'
  ListAppend e1 e2 == ListAppend e1' e2' = e1 == e1' && e2 == e2'
  ListBuild == ListBuild = True
  ListFold == ListFold = True
  ListLength == ListLength = True
  ListHead == ListHead = True
  ListLast == ListLast = True
  ListIndexed == ListIndexed = True
  ListReverse == ListReverse = True
  Optional == Optional = True
  OptionalLit e maybeE == OptionalLit e' maybeE' = e == e' && maybeE == maybeE'
  Some e == Some e' = e == e'
  None == None = True
  OptionalFold == OptionalFold = True
  OptionalBuild == OptionalBuild = True
  Record r == Record r' = r == r'
  RecordLit r == RecordLit r' = r == r'
  Union u == Union u' = u == u'
  UnionLit v e u == UnionLit v' e' u' = v == v' && e == e' && u == u'
  Combine e1 e2 == Combine e1' e2' = e1 == e1' && e2 == e2'
  CombineTypes e1 e2 == CombineTypes e1' e2' = e1 == e1' && e2 == e2'
  Prefer e1 e2 == Prefer e1' e2' = e1 == e1' && e2 == e2'
  Merge e1 e2 maybeE == Merge e1' e2' maybeE' = e1 == e1' && e2 == e2' && maybeE == maybeE'
  Constructors e1 == Constructors e1' = e1 == e1'
  Field e1 v == Field e1' v' = e1 == e1' && v == v'
  Project e1 vs == Project e1' vs' = e1 == e1' && vs == vs'
  Note s e1 == Note s' e1' = s == s' && e1 == e1'
  ImportAlt e1 e2 == ImportAlt e1' e2' = e1 == e1' && e2 == e2'
  Embed a == Embed a' = a == a'
  _ == _ = False
  {-# INLINABLE (==) #-}
