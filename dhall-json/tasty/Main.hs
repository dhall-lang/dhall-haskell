...
testTree =
    Test.Tasty.testGroup "dhall-json"
        ...
        , testDhallToJSON "./tasty/data/toArbitraryJSON_12.0.0"
        , testDhallToJSON "./tasty/data/toArbitraryJSON_13.0.0"
        ...
        , testJSONToDhall "./tasty/data/fromArbitraryJSON_12.0.0"
        , testJSONToDhall "./tasty/data/fromArbitraryJSON_13.0.0"
